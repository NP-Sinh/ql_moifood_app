...
class ChartFoodState extends State<ChartFood> {
  ...
  Widget _buildTooltip(BoxConstraints constraints) {
    ...
    if (left + tooltipWidth > widgetWidth) {
      left = _touchPosition.dx - tooltipWidth - 20;
    }
    if (top < 0) {
      top = 20;
    }
    if (top + tooltipHeight > widgetHeight) {
      top = widgetHeight - tooltipHeight - 20;
    }

    left = left.clamp(20.0, widgetWidth - tooltipWidth - 20);
    top = top.clamp(20.0, widgetHeight - tooltipHeight - 20);
